...
<div class="card" style="background-color: transparent; border-color: transparent; zoom: 50%; margin: .5em;">
        ...
        <tbody>
            ...
            <tr>
                <td class="input-group" style="border-color: transparent;">
                    ...
                    <button id="btnRfpnodata" class="btn btn-warning" style="height: 60px; border-radius: 0px;">
                ...
                <td><input type="text" class="form-control form-control-lg" readonly id="inputnmPayee"></td>
                <td><input type="text" class="form-control form-control-lg" readonly id="inputnmTransactiontype"></td>
                <td><input type="text" class="form-control form-control-lg" readonly id="inputnmAvailableamount"></td>
                <td><input type="text" class="form-control form-control-lg" readonly></td>
                <td><input type="text" class="form-control form-control-lg" readonly></td>
                <td><input type="date" class="form-control form-control-lg" readonly></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <select name="" id="inputnmAccountno" class="form-control form-control-lg">
                        <option value="1301-0327-29">1301-0327-29</option>
                    </select>
                </td>
                <td><input type="date" class="form-control form-control-lg"></td>
    ...
    <div class="row" style="margin-top: 1em;">
        ...
        <div class="col-md-2 d-grid">
            <button class="btn btn-dark" style="height: 80pt;">Save.</button>
        </div>
    </div>
</div>
            ...
            $.ajax({
                ...
                success:function(response){
                    if(response.success){
                        ...
                        response.data.forEach(function(x){
                            div += `
                                <button id="btnGetrequestdata" data-payee="${x['payee']}" data-payment="${x['payment']}" data-availableamount="${x['dummyamount']}" data-receivestatus="${x['receivestatus']}" data-receiveremark="${x['receiveremark']}" data-receivedata="${x['receivedata']}" data-description="${x['description']}"</button>
                            `;
                        })
